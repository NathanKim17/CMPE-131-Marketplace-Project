...
#@app.route("/itemInfo")
#def itemInfo():
    #itemOne = Item("Starbucks", "69", 1.69)
    #return render_template('itemInfo.html', item = itemOne)

#@app.route("/itemInfo")
#def itemInfo(itemArg):
    #return render_template('itemInfo.html', item = itemArg)
